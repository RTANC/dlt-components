DECLARE @d1 DATETIME2 = '2021-10-01T00:00:00' DECLARE @d2 DATETIME2 = '2022-09-30T23:59:59' DECLARE @sid INT = 1 DECLARE @MonthTable table (monthx int, mdate datetime) DECLARE @dm1 DATETIME = @d1 DECLARE @dm2 DATETIME = @d2 WHILE (@dm1 <= @dm2) BEGIN DECLARE @xdate datetime DECLARE @m int
SET
