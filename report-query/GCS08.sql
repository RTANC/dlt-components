DECLARE @d1 DATETIME2 = '2021-10-01T00:00:00' DECLARE @d2 DATETIME2 = '2022-09-30T23:59:59' DECLARE @sid INT = 1 DECLARE @YearTable table (yearx int, ydate datetime) DECLARE @y1 INT = DATEPART(YEAR, @d1) DECLARE @y2 INT = DATEPART(YEAR, @d2) WHILE (@y1 < @y2) BEGIN DECLARE @xdate datetime
SET
    @y1 = @y1 + 1
SET
