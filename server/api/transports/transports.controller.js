...
exports.getLicensePlates = async (req, res, next) => {
    try {
        ...
        from VehicleIn
        where TransportID IS NULL and VehicleOutID IS NULL and StationID = ${req.query.station} and (F1A like '${req.query.LPnumber}%' or R1A like '${req.query.LPnumber}%') and (TimeStampIn between '2021-06-01T00:00:00' and '2021-06-30T23:00:00')
