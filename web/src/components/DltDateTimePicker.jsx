      ...
      <LocalizationProvider dateAdapter={AdapterDateFns} adapterLocale={thLocale}>
        <FormControl fullWidth error={props.error !== false}>
          <MobileDateTimePicker
            ...
            renderInput={(params) => {params.inputProps.value =  moment(moment(params.inputProps.value).format('MM/DD/YYYY')).isValid() ? moment(params.inputProps.value).add(543, 'y').format('DD/MM/YYYY HH:mm') : ''; return <TextField {...params} focused color={(props.error !== false) ? 'error' : 'warning'}/>}}
          />
