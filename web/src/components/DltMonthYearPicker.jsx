      ...
      <LocalizationProvider dateAdapter={AdapterDateFns} adapterLocale={thLocale}>
        <FormControl fullWidth  error={props.error !== false}>
          <MobileDatePicker
            ...
            renderInput={(params) => {params.inputProps.value =  (typeof(params.inputProps.value) !== 'undefined' && params.inputProps.value !== null && params.inputProps.value !== '') ? moment(params.inputProps.value).add(543, 'y').format('MM/YYYY') : ''; return <TextField {...params} focused color={(props.error !== false) ? 'error' : 'warning'}/>}}
          />
