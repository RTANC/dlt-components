  ...
  return (
    <FormControl fullWidth>
      <InputLabel>{props.label}</InputLabel>
        <OutlinedInput onKeyUp={props.onKeyUp} type={props.type} label={props.label} value={props.value} onChange={props.onChange} error={props.error !== false} name={props.name} disabled={props.disabled} startAdornment={props.startIcon && (<InputAdornment position="start">{props.startIcon}</InputAdornment>)}/>
