    ...
    <LocalizationProvider dateAdapter={AdapterDateFns} adapterLocale={thLocale}>
      ...
      <InputLabel shrink sx={{fontSize: 20, color: '#ed6c02'}}>{props.label}</InputLabel>
        <MobileDatePicker
          ...
          renderInput={(params) => {params.inputProps.value =  (typeof(params.inputProps.value) !== 'undefined' && params.inputProps.value !== null && params.inputProps.value !== '') ? moment(params.inputProps.value).add(543, 'y').format('YYYY') : ''; return <DltOutlinedInput {...params}/>}}
        />
